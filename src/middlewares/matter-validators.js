...
import { uidExist , uidMatterExist} from "../helpers/db-validators.js";
...
export const deleteMatterValidator = [
    check("uid").not().isEmpty().isMongoId().withMessage("The ID is required"),
    check("uid").custom(uidMatterExist),
    body("KeyUserUid").not().isEmpty().withMessage("The User ID is required").isMongoId().withMessage("Invalid User ID format").custom(uidExist),
    validationsFields
...
export const deleteUserFromMatterValidator = [
    check("uid").not().isEmpty().withMessage("The Matter ID is required").isMongoId().withMessage("Invalid Matter ID format").custom(uidMatterExist),
    body("KeyUserUid").not().isEmpty().withMessage("The User ID is required").isMongoId().withMessage("Invalid User ID format").custom(uidExist),
    body("userDeleteUid").not().isEmpty().withMessage("The user to be removed is required").isMongoId().withMessage("Invalid User ID format").custom(uidExist),
    validationsFields
];
export const getMatterIdValidator = [
    check("uid").isMongoId().withMessage("This Id isn't valid").custom(uidExist),
    validationsFields
];
